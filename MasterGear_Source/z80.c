...
/** In this case you will need: Z80.c, Z80.h, Tables.h,     **/
/** Codes.h, CodesED.h, CodesCB.h, CodesXX.h, CodesXCB.h.   **/
/**   Don't forget to write DoIn(), DoOut(), M_PATCH(),     **/
/** M_RDMEM(), and M_WRMEM() functions to accomodate the    **/
...
/** Variables ************************************************/
/** Z80 registers, running flag, etc.                       **/
/*************************************************************/
byte TrapBadOps = 0;
byte CPURunning = 0;
static reg R;
...
{
  Regs->PC.W=0x0000;Regs->SP.W=0xF000;
  Regs->AF.W=Regs->BC.W=Regs->DE.W=Regs->HL.W=0x0000;
  Regs->AF1.W=Regs->BC1.W=Regs->DE1.W=Regs->HL1.W=0x0000;
