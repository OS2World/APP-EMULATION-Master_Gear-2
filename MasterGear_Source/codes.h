...
case ADD_xHL:  I=M_RDMEM(R.HL.W);M_ADD(I);break;
case ADD_BYTE: I=M_RDMEM(R.PC.W++);M_ADD(I);break;
...
case SUB_xHL:  I=M_RDMEM(R.HL.W);M_SUB(I);break;
case SUB_BYTE: I=M_RDMEM(R.PC.W++);M_SUB(I);break;
...
case AND_xHL:  I=M_RDMEM(R.HL.W);M_AND(I);break;
case AND_BYTE: I=M_RDMEM(R.PC.W++);M_AND(I);break;
...
case OR_xHL:   I=M_RDMEM(R.HL.W);M_OR(I);break;
case OR_BYTE:  I=M_RDMEM(R.PC.W++);M_OR(I);break;
...
case ADC_xHL:  I=M_RDMEM(R.HL.W);M_ADC(I);break;
case ADC_BYTE: I=M_RDMEM(R.PC.W++);M_ADC(I);break;
...
case SBC_xHL:  I=M_RDMEM(R.HL.W);M_SBC(I);break;
case SBC_BYTE: I=M_RDMEM(R.PC.W++);M_SBC(I);break;
...
case XOR_xHL:  I=M_RDMEM(R.HL.W);M_XOR(I);break;
case XOR_BYTE: I=M_RDMEM(R.PC.W++);M_XOR(I);break;
...
case CP_xHL:   I=M_RDMEM(R.HL.W);M_CP(I);break;
case CP_BYTE:  I=M_RDMEM(R.PC.W++);M_CP(I);break;
...
case LD_A_xBC: R.AF.B.h=M_RDMEM(R.BC.W);break;
...
case DEC_xHL:  I=M_RDMEM(R.HL.W);M_DEC(I);M_WRMEM(R.HL.W,I);break;
...
case INC_xHL:  I=M_RDMEM(R.HL.W);M_INC(I);M_WRMEM(R.HL.W,I);break;
...
case NOP:  break;
case EI:   R.IFF|=0x01;break;
case DI:   R.IFF&=0xFE;break;
case OUTA: DoOut(M_RDMEM(R.PC.W++),R.AF.B.h);break;
case INA:  R.AF.B.h=DoIn(M_RDMEM(R.PC.W++));break;
...
case LD_xHL_B: M_WRMEM(R.HL.W,R.BC.B.h);break;
...
case LD_xHL_C: M_WRMEM(R.HL.W,R.BC.B.l);break;
...
case LD_xHL_D: M_WRMEM(R.HL.W,R.DE.B.h);break;
...
case LD_xHL_E: M_WRMEM(R.HL.W,R.DE.B.l);break;
...
case LD_xHL_H: M_WRMEM(R.HL.W,R.HL.B.h);break;
...
case LD_xHL_L: M_WRMEM(R.HL.W,R.HL.B.l);break;
...
case LD_xHL_A: M_WRMEM(R.HL.W,R.AF.B.h);break;

case LD_xBC_A: M_WRMEM(R.BC.W,R.AF.B.h);break;
case LD_xDE_A: M_WRMEM(R.DE.W,R.AF.B.h);break;

case LD_B_xHL:    R.BC.B.h=M_RDMEM(R.HL.W);break;
case LD_C_xHL:    R.BC.B.l=M_RDMEM(R.HL.W);break;
case LD_D_xHL:    R.DE.B.h=M_RDMEM(R.HL.W);break;
case LD_E_xHL:    R.DE.B.l=M_RDMEM(R.HL.W);break;
...
case LD_B_BYTE:   R.BC.B.h=M_RDMEM(R.PC.W++);break;
case LD_C_BYTE:   R.BC.B.l=M_RDMEM(R.PC.W++);break;
...
case LD_A_xWORD:
  J.B.l=M_RDMEM(R.PC.W++);
  J.B.h=M_RDMEM(R.PC.W++); 
  R.AF.B.h=M_RDMEM(J.W);
  break;

case LD_xWORD_A:
  J.B.l=M_RDMEM(R.PC.W++);
  J.B.h=M_RDMEM(R.PC.W++);
  M_WRMEM(J.W,R.AF.B.h);
  break;

case EX_HL_xSP:
  J.B.l=M_RDMEM(R.SP.W);M_WRMEM(R.SP.W++,R.HL.B.l);
  J.B.h=M_RDMEM(R.SP.W);M_WRMEM(R.SP.W--,R.HL.B.h);
  R.HL.W=J.W;
  break;
...
case DAA:
  ...
  (
    (R.AF.B.l&C_FLAG)?
      (((R.AF.B.l&H_FLAG)? 0x9A00:0xA000)+C_FLAG):
      ((R.AF.B.l&H_FLAG)? 0xFA00:0x0000)
  )
  :
  (
    (R.AF.B.l&C_FLAG)?
      (((R.AF.B.l&H_FLAG)? 0x6600:((J.B.h<0x0A)? 0x6000:0x6600))+C_FLAG):
      (
        (R.AF.B.l&H_FLAG)?
          ((R.AF.B.h<0xA0)? 0x0600:(0x6600+C_FLAG)):
          (
            (J.B.h<0x0A)? 
              ((R.AF.B.h<0xA0)? 0x0000:(0x6000+C_FLAG)): 
	      ((R.AF.B.h<0x90)? 0x0600:(0x6600+C_FLAG))
          )
      )
  );
  R.AF.B.h+=J.B.h;
  FLAGS(R.AF.B.h,PTable[R.AF.B.h]|J.B.l|(R.AF.B.l&N_FLAG));
  break;
